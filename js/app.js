              ...
              <div class="post__header">
                <div class="post__profile">
                  <a
                    ...
                    class="post__avatar"
                  >
                    <img src="${userProfileImage}" alt="User Picture" />
                  </a>
...
const displayLikedPosts = () => {
  ...
  const containerLikePost = document.getElementById('liked');
  containerLikePost.textContent = '';
  likedPosts.forEach((post) => {
    const div = createPost(post);
    containerLikePost.appendChild(div);
  });
};

const displayReportedPosts = () => {
  const reportedPosts = getReportedPosts();
  const containerReportedPost = document.getElementById("reported");
  containerReportedPost.textContent = '';
  reportedPosts.forEach((post) => {
    const div = createPost(post);
    containerReportedPost.appendChild(div);
  });
};
